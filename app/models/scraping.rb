class Scraping
 ...
 def self.get_product(link)
  agent = Mechanize.new
  page = agent.get(link)
  name= page.at('.clearfix .display-name').inner_text if name= page.at('.clearfix .display-name').inner_text
  text = page.at('#contents-maintext h3').inner_text if text = page.at('#contents-maintext h3').inner_text
